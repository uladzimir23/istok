...
> **Уточнение (2026-06-26):** решение — «Next.js, App Router, последний стабильный».
> На момент ADR это была v15; при имплементации проект встал на **Next.js 16**
> (`web/package.json` → `next@16.x`). Это версионный апгрейд в рамках того же решения,
> не новый ADR. Заголовок/файл оставлены прежними ради стабильности wiki-ссылок.
